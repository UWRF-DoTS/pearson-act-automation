...
#>
$schedule = @{
	"holidays" = @((Get-Date "09-04-2017"), (Get-Date "11-24-2017"), (Get-Date "12-25-2017"), (Get-Date "01-01-2018"), (Get-Date "01-15-2018"), (Get-Date "09-01-2018"), (Get-Date "05-28-2018"), (Get-Date "07-04-2018"));;
